...
class JSLTLexer(RegexLexer):
    ...
    tokens = {
        ...
        "constant": [(r"[A-Z_a-z][0-9A-Z_a-z-]*", Name.Variable, "root"),],
        "function": [
            (
        ...
        "import-path": [(r'"([^"]|\\.)*"', String.Symbol, "root"),],
        "import-alias": [(r"[A-Z_a-z][0-9A-Z_a-z-]*", Name.Namespace, "root"),],
        "string": [(r'"', String.Double, "#pop"), (r"\\.", String.Escape),],
        "whitespace": [
            (r"[\t\n\f\r ]+", Whitespace),
            (r"//.*(\n|\Z)", Comment.Single),
        ],
