...
class Modula2Lexer(RegexLexer):
    ...
    tokens = {
        "whitespace": [(r"\n+", Text), (r"\s+", Text),],  # blank lines  # whitespace
        "dialecttags": [
            # PIM Dialect Tag
    ...
    builtins_db = {
        ...
        "m2iso+p1": (common_builtins, iso_additional_builtins, p1_additional_builtins,),
    ...
    stdlib_modules_db = {
        ...
        "objm2": (m2r10_stdlib_blueprint_identifiers, m2r10_stdlib_module_identifiers,),
