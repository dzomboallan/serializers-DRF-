...
class ScalaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "annotations": [(r"@%s" % idrest, Name.Decorator),],
        "using": [
        ...
        "symbols": [(r"('%s)(?!')" % plainid, String.Symbol),],
        "singleton-type": [(r"(\.)(type)\b", bygroups(Punctuation, Keyword)),],
        "inline": [
        ...
        "names": [(idUpper, Name.Class), (anyId, Name),],
        # States
        "comment": [
            (r"[^/*]+", Comment.Multiline),
...
class GoloLexer(RegexLexer):
    ...
    tokens = {
        ...
        "triplestring": [(r'"""', String, "#pop"), include("string"), (r"\n", String),],
