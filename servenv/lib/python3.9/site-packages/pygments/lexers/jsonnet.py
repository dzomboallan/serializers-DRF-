...
class JsonnetLexer(RegexLexer):
    ...
    tokens = {
        ...
        "array": [(r",", Punctuation), (r"\]", Punctuation, "#pop"), include("root"),],
        "local_name": [
        ...
        "assert": [(r":", Punctuation), (r";", Punctuation, "#pop"), include("root"),],
        "function_params": [
            (jsonnet_token, Name.Variable),
            (r"\(", Punctuation),
            (r"\)", Punctuation, "#pop"),
        ...
        "field_name_expr": [(r"\]", Operator, "field_separator"), include("root"),],
