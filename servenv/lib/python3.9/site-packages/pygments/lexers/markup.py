...
class TexLexer(RegexLexer):
    ...
    tokens = {
        ...
        "command": [(r"\[.*?\]", Name.Attribute), (r"\*", Keyword), default("#pop"),],
    }
...
class MozPreprocHashLexer(RegexLexer):
    ...
    tokens = {
        "root": [(r"^#", Comment.Preproc, ("expr", "exprstart")), (r".+", Other),],
        "exprstart": [
...
class WikitextLexer(RegexLexer):
    ...
    tokens = {
        ...
        "lc-flag": [(r"\s+", Whitespace), (r";", Punctuation), *text_rules(Keyword),],
        "lc-inner": [
            (
                r"""(?xi)
                (;)
        ...
        "lc-raw": [(r"\}-", Punctuation, "#pop"), include("inline"), include("text"),],
        "replaceable": [
            # Comments
        ...
        "nowiki-ish": [include("entity"), include("text"),],
        "attr": [
            include("replaceable"),
            (r"\s+", Whitespace),
            (
        ...
        "tag-inner-ordinary": [(r"/?\s*>", Punctuation, "#pop"), include("tag-attr"),],
        "tag-inner": [
