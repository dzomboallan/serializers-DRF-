...
class ProtoBufLexer(RegexLexer):
    ...
    tokens = {
        ...
        "package": [(r"[a-zA-Z_]\w*", Name.Namespace, "#pop"), default("#pop"),],
...
class ThriftLexer(RegexLexer):
    ...
    tokens = {
        ...
        "sqs": [(r"'", String.Single, "#pop"), (r"[^\\\'\n]+", String.Single),],
        "namespace": [(r"[a-z*](\.\w|\w)*", Name.Namespace, "#pop"), default("#pop"),],
...
class AlloyLexer(RegexLexer):
    ...
    tokens = {
        ...
        "fun": [text_tuple, (r"\{", Operator, "#pop"), (iden_rex, Name, "#pop"),],
        "fact": [include("fun"), (string_rex, String, "#pop"),],
        "root": [
            (r"--.*?$", Comment.Single),
            (r"//.*?$", Comment.Single),
            (r"/\*.*?\*/", Comment.Multiline),
