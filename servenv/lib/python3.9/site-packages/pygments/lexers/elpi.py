...
class ElpiLexer(RegexLexer):
    ...
    tokens = {
        ...
        "elpi-indexing-expr": [(r"[0-9 _]+", Number.Integer), (r"\)", Text, "#pop"),],
        "elpi-type": [
        ...
        "elpi-btick": [(r"[^` ]+", String.Double), (r"`", String.Double, "#pop"),],
        "elpi-tick": [(r"[^\' ]+", String.Double), (r"\'", String.Double, "#pop"),],
        "elpi-string": [(r"[^\"]+", String.Double), (r'"', String.Double, "#pop"),],
        "elpi-quote": [
            (r"\{\{", Punctuation, "#push"),
            (r"\}\}", Punctuation, "#pop"),
            (
                r"(lp:)((?=[A-Z_]){})".format(constant_re),
