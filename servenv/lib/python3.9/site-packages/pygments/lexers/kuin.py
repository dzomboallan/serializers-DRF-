...
class KuinLexer(RegexLexer):
    ...
    tokens = {
        ...
        "if_sp": [include("expr"), (r"\n", Whitespace, "#pop"),],
        "switch_": [include("expr"), (r"\n", Whitespace, "switch"),],
        "switch": [
            (
                r"\b(end)([ \t]+(?:\n\s*\|)*[ \t]*)(switch)\b",
                bygroups(Keyword, using(this), Keyword),
        ...
        "switch_sp": [include("expr"), (r"\n", Whitespace, "#pop"),],
        "while_": [include("expr"), (r"\n", Whitespace, "while"),],
        "while": [
            (
                r"\b(end)([ \t]+(?:\n\s*\|)*[ \t]*)(while)\b",
                bygroups(Keyword, using(this), Keyword),
        ...
        "alias": [include("expr"), (r"\n", Whitespace, "#pop"),],
        "assert": [include("expr"), (r"\n", Whitespace, "#pop"),],
        "const": [include("expr"), (r"\n", Whitespace, "#pop"),],
        "do": [include("expr"), (r"\n", Whitespace, "#pop"),],
        "ret": [include("expr"), (r"\n", Whitespace, "#pop"),],
        "throw": [include("expr"), (r"\n", Whitespace, "#pop"),],
        "var": [include("expr"), (r"\n", Whitespace, "#pop"),],
        "continued_line": [include("expr"), (r"\n", Whitespace, "#pop"),],
        "expr": [
            # Whitespace / Comment
            include("whitespace"),
            # Punctuation
        ...
        "toStrInString": [include("expr"), (r"\}", String.Double, "#pop"),],
    }
