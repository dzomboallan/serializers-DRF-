...
class HaxeLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "optional-expr": [include("spaces"), include("expr"), default("#pop"),],
        "class-method": [
            include("spaces"),
            (
                ident,
        ...
        "array-access-close": [include("spaces"), (r"\]", Punctuation, "#pop"),],
        ...
        "parenthesis-close": [include("spaces"), (r"\)", Punctuation, "#pop"),],
        "var": [
            include("spaces"),
            (
                ident_no_keyword,
